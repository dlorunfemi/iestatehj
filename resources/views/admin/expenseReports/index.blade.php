...
<div class="card">
    <div class="card-header">
        {{ trans('global.expenseReport.reports.incomeReport') }}
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>{{ trans('global.expenseReport.reports.income') }}</th>
                        <td>{{ number_format($incomesTotal, 2) }}</td>
                    </tr>
                    <tr>
                        <th>{{ trans('global.expenseReport.reports.expense') }}</th>
                        <td>{{ number_format($expensesTotal, 2) }}</td>
                    </tr>
                    <tr>
                        <th>{{ trans('global.expenseReport.reports.profit') }}</th>
            ...
            <div class="col">
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>{{ trans('global.expenseReport.reports.incomeByCategory') }}</th>
            ...
            <div class="col">
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>{{ trans('global.expenseReport.reports.expenseByCategory') }}</th>
